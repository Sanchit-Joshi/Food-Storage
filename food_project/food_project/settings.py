...
SECRET_KEY = 'django-insecure-o^=3q+zg&44ix2p!m7g_--95i*bks@^$sid%u1j75cr#c+_^%d'
...
# Check if we're running in Docker with PostgreSQL
try:
    if os.environ.get('DATABASE_URL'):
        ...
        DATABASES = {
            'default': {
                ...
                'NAME': os.environ.get('POSTGRES_DB', 'food_storage_db'),
    ...
    # Fallback to SQLite if PostgreSQL packages are not available
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.sqlite3',
            'NAME': BASE_DIR / 'db.sqlite3',
